package com.yellowtwigs.knockin.ui.groups.section//package com.yellowtwigs.knockin.ui.groups.list
//
...
//                          len: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//                                        mContext.startActivity(Intent(mContext, GroupsListActivity::class.java))
//                                    }
...
//                    if (mContext is GroupsListActivity) mContext.refreshActivity()
//                }
