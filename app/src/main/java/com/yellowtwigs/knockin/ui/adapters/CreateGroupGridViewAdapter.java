...
//        parentGrid = ((GridView) parent);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            contactFirstNameView = view.findViewById(R.id.contact_first_name);
            contactLastNameView = view.findViewById(R.id.contact_last_name);
            gridContactItemLayout = view.findViewById(R.id.grid_contact_item_layout);
            contactRoundedImageView = view.findViewById(R.id.contact_image);
            gridAdapterFavoriteShine = view.findViewById(R.id.favorite_shine);
//            heightWidthImage = holder.contactRoundedImageView.getLayoutParams().height;
        }
    }
