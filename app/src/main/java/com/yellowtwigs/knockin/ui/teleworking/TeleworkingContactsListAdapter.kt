...
class TeleworkingContactsListAdapter(private val context: Context) :
    ListAdapter<ContactWithAllInformation, TeleworkingContactsListAdapter.ViewHolder>(
        ContactComparator()
    ) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemContactSelectedLayoutBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ItemContactSelectedLayoutBinding) :
        ...
        fun onBind(contactWithAllInformation: ContactWithAllInformation, context: Context) {
