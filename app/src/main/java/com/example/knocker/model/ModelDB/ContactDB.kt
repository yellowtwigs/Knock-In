...
data class ContactDB(
        ...
        @ColumnInfo(name = "profile_picture") val profilePicture: Int,              //image de profile du contact //TODELETE
        @ColumnInfo(name = "background_image") val backgroundImage: Int,            //image d'arriere plan du contact // TODELETE
