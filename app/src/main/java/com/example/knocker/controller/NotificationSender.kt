        ...
        if(!isNotificationServiceEnabled(context)) {
            ...
            val runnableSendNotif = Runnable {
                ...
                val notification = NotificationCompat.Builder(context, CHANNEL_ID)
                        ...
                        .setContentTitle(context.getString(R.string.notification_sender_content_tittle))
                        ...
                        .setStyle(
                                NotificationCompat.BigTextStyle()
                                        ...
                                        .setBigContentTitle(context.getString(R.string.notification_sender_content_tittle))
                                        .setSummaryText(""))
